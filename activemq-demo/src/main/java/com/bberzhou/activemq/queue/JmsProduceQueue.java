...
/**
 * @description: 测试activeMQ的消息生产者，destination是queue
...
public class JmsProduceQueue {
    ...
    public static void main(String[] args) throws JMSException {
        ...
        for (int i = 1; i <= 5 ; i++) {
            ...
            // 除了消息头之外，还可以额外的给消息添加消息属性，它是以key,value键值对的形式设置的，
            // 可以通过这个来对消息进行进一步的识别/去重/重点标注等操作
            textMessage.setStringProperty("attr1","attr_value1");
